...
@Component({
  ...
  imports: [IonHeader, IonToolbar, IonTitle, IonContent, IonCard, IonCardHeader, IonCardTitle, IonCardSubtitle, RouterLink, IonIcon, IonButton, IonItem, IonSelect, IonSelectOption, FormsModule],
})
